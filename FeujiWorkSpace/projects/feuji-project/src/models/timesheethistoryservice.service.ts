...
export class TimesheethistoryserviceService {
  ...
  constructor(private http: HttpClient
    ...
    taskHistoryUrl="http://13.48.82.196:8084/api/timesheet/gettimeSheetHistory"
  accounturl="http://13.48.82.196:8083/api/AccountProjectResourceMapping/accountdetails"
  dayaHistory="http://13.48.82.196:8084/api/timesheetday"
